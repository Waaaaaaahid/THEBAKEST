...
interface Stats { total_orders:number; today_orders:number; revenue:number; pending_orders:number; preparing_orders:number; out_for_delivery:number; delivered_orders:number; cancelled_orders:number; customers:number; total_menu_items:number; category_count:number; pending_reviews:number; recent_orders:Order[]; }
